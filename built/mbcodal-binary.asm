...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2116 (incl. 1408 user, 664 helpers, 12 vtables, 32 lits); src size 0
; assembly: 1415 lines; density: 704 bytes/stmt; (2 stmts)
; total bytes: 292932 (62.2% of 460.0k flash with 178108 free)
...
; start
    ...
    .hex 22204AC874977E7F ; hex template hash
...
; Function main.ts(1,1): <main>
    ;
    .object _main___P3060 "main.ts(1,1): <main>"
_main___P3060_pre:
    .section code
    .balign 4
_main___P3060_Lit:
